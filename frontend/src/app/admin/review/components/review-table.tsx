...
import { ReviewWithProduct } from "@/types/review.type";
      ...
      {reviews.map((review) => (
        <Fragment key={review._id}>
          <div className="md:px-4 py-2 lg:flex items-start gap-10 space-y-2 lg:space-y-0">
            {/* Product Info */}
            <div className="w-full md:w-[400px] flex items-center gap-4">
              <img
                src={
            ...
            <div className="flex-1 space-y-2">
              <div className="flex justify-between items-start">
                ...
                {!review.shopReply && (
                  <button className="py-1 px-3 flex items-center gap-2 bg-black text-white cursor-pointer">
